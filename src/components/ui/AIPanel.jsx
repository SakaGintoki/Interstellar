...
const ChatInputArea = ({ onSubmit, isLoading }) => {
  ...
  return (
    <form
      ...
      className="relative mt-auto pt-4 border-t border-white/10 bg-black/20 backdrop-blur-md p-4"
    >
      ...
      <div className="flex justify-between items-center mt-2">
        <span className="text-[8px] text-cyan-600/50 font-mono">
    ...
    <>
      ...
      >
        ...
        <div className="h-1/2 flex flex-col bg-slate-900/90 backdrop-blur-xl border border-cyan-500/20 shadow-[-20px_0_50px_rgba(0,0,0,0.5)] rounded-2xl overflow-hidden">
          ...
          <div
            ref={scrollRef}
            // Ganti class scrollbar lama dengan class untuk menyembunyikannya
            className="flex-1 overflow-y-auto p-6 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
          >
